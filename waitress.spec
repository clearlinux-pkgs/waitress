...
Version  : 1.4.0
Release  : 59
URL      : https://files.pythonhosted.org/packages/0b/fc/b2d3c1fc2078a528dae4ea33865df988b0428fafdb0950e795771b399be2/waitress-1.4.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/0b/fc/b2d3c1fc2078a528dae4ea33865df988b0428fafdb0950e795771b399be2/waitress-1.4.0.tar.gz
...
%prep
%setup -q -n waitress-1.4.0
cd %{_builddir}/waitress-1.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1577144002
...
cp %{_builddir}/waitress-1.4.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/waitress/a0b53f43aab58b46bf79ba756c50771c605ab4c5
