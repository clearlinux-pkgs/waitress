...
Source0  : https://files.pythonhosted.org/packages/55/0b/f178246f1658a360aa1fb4ae3cb4905ff479fe85e8a58cd7c8bd27192342/waitress-1.4.3.tar.gz
...
%prep
%setup -q -n waitress-1.4.3
cd %{_builddir}/waitress-1.4.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580752231
...
cp %{_builddir}/waitress-1.4.3/LICENSE.txt %{buildroot}/usr/share/package-licenses/waitress/a0b53f43aab58b46bf79ba756c50771c605ab4c5
